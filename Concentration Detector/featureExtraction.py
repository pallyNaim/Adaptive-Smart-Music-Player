...
def append_to_csv(features, csv_file='music_features.csv'):
...
def process_directory(directory, csv_file='music_features.csv'):
...
process_directory(directory, csv_file='music_features.csv')
